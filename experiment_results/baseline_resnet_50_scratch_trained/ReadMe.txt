...
10.38% gap between training and val performance (overfitting)
Val Top-5: 75.15%
...
Augmentation: Resize to 224x224, random horizontal flip, ImageNet normalization. No cropping, rotation, or color jitter.
