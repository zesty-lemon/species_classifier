...
from utils.dataset_utils import return_specified_kingdom
...
def load_national_plant_train_vermont_val(dataset_name,
                                          data_path,
                                          device_name,
                                          batch_size=128) -> Tuple[DataLoader, DataLoader, int]:
    ...
    national_plant_dataset = return_specified_kingdom(full_dataset=full_dataset,
                                                      kingom_name='Plantae')

    # Flatten nested subsets and create contiguous integer labels
    train_set = dataset_utils.FlatDataset(national_plant_dataset)
    val_set = dataset_utils.FlatDataset(vermont_val_plant_dataset, cat_id_to_label=train_set.cat_id_to_label)
