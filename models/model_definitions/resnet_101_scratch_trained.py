...
"""
Code to instantiate a ResNet101 Model
"""

class ResNet101_Model(nn.Module):
    """
    ResNet-101 with Bottleneck blocks. Configuration: [3, 4, 23, 3]
    """
    ...
    def __init__(self, num_classes=10):
        ...
        # ===== 3. Residual Stages =====
        # ResNet-101 configuration: [3, 4, 23, 3] blocks per stage
        ...
        # ONLY CHANGE IS HERE: 'blocks' changed from 6 to 23
        self.layer3 = self._make_layer(in_channels=512, channels=256, blocks=23, stride=2)
        ...
        # Final classifier: 2048 features -> num_classes
        self.fc = nn.Linear(2048, num_classes)

    def _make_layer(self, in_channels, channels, blocks, stride=1):
        """
        Create a layer with BottleNeck_Block blocks.
