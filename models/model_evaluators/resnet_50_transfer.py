...
from model_definitions import resnet_50_transfer
...
# ------------ Initialize Model ------------
resnet50_model = resnet_50_transfer.create_transfer_model(num_classes=num_plant_classes)
...
evaluate_utils.generate_performance_report(model=resnet50_model,
                                           ...
                                           dataset_name=CURRENT_DATASET_NAME,
                                           name=MODEL_NAME,
                                           annotation="Transfer Learning - Frozen Backbone")
